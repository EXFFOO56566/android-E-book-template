...
public class SimpleExpandableListAdapter extends BaseExpandableListAdapter {
	 ...
	 *            with this {@link SimpleExpandableListAdapter} is running
	 * @param groupData
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (mSelectedGroup == groupPosition && mSelectedChild == childPosition) {
		    v.setBackgroundColor(mContext.getResources().getColor(R.color.default_title_indicator_footer_color));
		} else {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (mSelectedGroup == groupPosition) {
			v.setBackgroundColor(mContext.getResources().getColor(R.color.default_title_indicator_footer_color));
		} else {
			v.setBackgroundColor(Color.TRANSPARENT);
		}
